...
# ---------------------------------------------------------------------------- 
# Bank 34
set_property PACKAGE_PIN L15 [get_ports {O_cathode[0]   }];  # "L15.PMOD1_D0_P" Pin 1
set_property PACKAGE_PIN M15 [get_ports {O_cathode[1]   }];  # "M15.PMOD1_D0_N" Pin 2
set_property PACKAGE_PIN L14 [get_ports {O_cathode[2]   }];  # "L14.PMOD1_D1_P" Pin 3
set_property PACKAGE_PIN M14 [get_ports {O_cathode[3]   }];  # "M14.PMOD1_D1_N" Pin 4
set_property PACKAGE_PIN K13 [get_ports {O_cathode[4]   }];  # "K13.PMOD1_D2_P" Pin 7
set_property PACKAGE_PIN L13 [get_ports {PMOD1_D2_N     }];  # "L13.PMOD1_D2_N" Pin 8
set_property PACKAGE_PIN N13 [get_ports {PMOD1_D3_P     }];  # "N13.PMOD1_D3_P" Pin 9
set_property PACKAGE_PIN N14 [get_ports {PMOD1_D3_N     }];  # "N14.PMOD1_D3_N" Pin 10
...
set_property PACKAGE_PIN R13 [get_ports {PMOD2_D3_N     }];  # "R13.PMOD2_D3_N" Pin 10
